        ...
        <div className="bg-[url('/img/ocean.webp')] bg-cover bg-center h-screen flex">
            <div className="w-1/2 p-8 text-white overflow-y-auto">
                ...
                <ul className="list-disc list-inside text-lg mb-4">
                    <li><a href="https://www.example.com/ocean-pollution" className="text-blue-400 underline">Contaminación de los océanos: causas y soluciones</a></li>
                    <li><a href="https://www.example.com/river-pollution" className="text-blue-400 underline">La contaminación en los ríos: impacto y soluciones</a></li>
                    <li><a href="https://www.example.com/plastic-impact" className="text-blue-400 underline">Impacto de los plásticos en los océanos y el medioambiente marino</a></li>
                    <li><a href="https://www.example.com/water-pollution-health" className="text-blue-400 underline">Efectos de la contaminación del agua en la salud humana</a></li>
                </ul>
                <p className="text-lg">
